...
"use strict";!function(e,n,t){e.extend(e.fn,{display:function(n){var t=this.length;if(t)if(1===t){if(void 0===n){var i=!this.hasClass("hidden");return i}n?this.removeClass("hidden"):this.addClass("hidden")}else this.each(function(){n?e(this).removeClass("hidden"):e(this).addClass("hidden")});return this}});var i=function(){for(var e=navigator.userAgent,n=["Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"],t=!0,i=0;i<n.length;i++)if(e.indexOf(n[i])>0){t=!1;break}return t},o=function(e){e.preventDefault()},a=function(){var e=navigator.userAgent.toLowerCase();return"micromessenger"==e.match(/MicroMessenger/i)?!0:!1},s=!1,r=function(n){n&&(document.body.addEventListener("touchmove",o,!1),e("#share_guide").display(1))},d=function(n){var i=t.PD.get("wxconfig");if(i){try{i=JSON.parse(i)}catch(o){}var a=document.createElement("script");a.src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js",a.onload=function(){wx.config({debug:!1,appId:i.appId,timestamp:i.timestamp,nonceStr:i.nonceStr,signature:i.signature,jsApiList:["checkJsApi","onMenuShareAppMessage"]}),wx.ready(function(){n&&n()})},e("body")[0].appendChild(a),d=null}},c=e("div.ui-mask").css("position","fixed"),u=e("body"),h=i()?"click":"tap",l="touchend",p=function(n,t,i){var o,a=(e(t),e(t).get(0)),s=!0,r=!0;"object"===e.type(n)?(o=n.evt,s=n.hasOwnProperty("pd")?n.pd:s,r=n.hasOwnProperty("sp")?n.sp:r):o=n,e(t).on(l,function(n){var t=e.Event(o);a.dispatchEvent(t),s&&n.preventDefault(),r&&n.stopPropagation()}),e(t).on(o,i)};t.on("show-mask",function(n){n.show?(c.display(1),e("html").css("overflow","hidden"),document.body.addEventListener("touchmove",o,!1)):(c.display(0),e("html").css("overflow","auto"),document.body.removeEventListener("touchmove",o))}),t.on("xsc-gz-ad",function(){for(var n,t=["channel_index_tgw_wap_a1","article_ad_wap4","channel_list_tgw_wap_a1"],i=0,o=t.length;o>i;i++)if(n=e("#"+t[i]),n.length){var a=callad(t[i],"",1);n.html(a);break}}),function(){function e(){if("undefined"==typeof remote_ip_info){if(i>1e3)return;return i++,void(n=setTimeout(e,400))}clearTimeout(n),n=null,"广州"===remote_ip_info.city&&t.fire("xsc-gz-ad"),document.head.removeChild(o)}var n,i=0,o=document.createElement("script");o.src="http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=js",document.head.appendChild(o),e()}(),p(h,c,function(){e("#navToggle").trigger(h)}),u.on(h,"a",function(n){e(n.target).addClass("active"),setTimeout(function(){e(n.target).removeClass("active")},500)}),e(function(){if(p(h,e("#navToggle"),function(){var n=1;u.hasClass("hide-nav")&&u.removeClass("hide-nav"),u.hasClass("show-nav")&&(n=0,u.addClass("hide-nav")),e(this).toggleClass("active"),u.toggleClass("show-nav"),t.fire("show-mask",{show:n})}),a()){var n=e("#weixinshare");p(h,n,function(){s||(d?(s=!0,d(function(){s=!1,r(!0),wx.onMenuShareAppMessage({imgUrl:"http://file.gaofen.com/html/mobile/images/wxartlogo.jpg",success:function(){},cancel:function(){}})})):r(!0))}),n.parent().display(1),p(h,e("#share_guide"),function(){document.body.removeEventListener("touchmove",o),e(this).display(0)})}})}(Zepto,window,Gaofen);
/*!07-07-2015 16:32 customform-front-js */
...
!function(e,l,t){t.tpls={get:function(e){return this[e]},getItemView:function(l,i){var a=this.get("field"),s=t.util.parse(this.get(l),i);return t.util.parse(a,e.extend({item_content:s},i))},field:['<div class="field">','<div class="form-group">','<label class="control-label">{.title_value}',"</label>",'<div class="help-block">{.tips_value}',"</div>",'<div class="controls">',"{.item_content}",'<div class="error-message hidden"  id="error_tips"><i class="fa fa-warning"></i><span>出错啦</span></div>',"</div>","</div>","</div>"].join(""),code_text:['<div class="field" rel="e:field,id:{.field_id},type:{.field_type}"><i class="fa fa-bars sort-handler"></i>','<div class="icons">',"</div>",'<div class="form-group">','<label class="control-label" id="title_txt">{.title_value}',"</label>",'<div class="controls">','<input value="" rows="3" name="default_value" disabled="disabled" class="">DiNs',"</div>","</div>","</div>"].join(""),single_line_text:['<input type="text" value="{.default_value}" class="form-control {.extcss}"/>'].join(""),paragraph_text:['<textarea rows="3" class="form-control"></textarea>'].join(""),phone_text:['<input type="text"  value="{.default_value}" class="form-control {.extcss}"/>'].join(""),phone_mobile_text:['<input type="text"  value="{.default_value}" class="form-control {.extcss}"/>'].join(""),choice_text:['<div class="choices" id="choice_main">{.chooses}</div>'].join(""),single_choice_inline_text:['<label class="radio-inline"><input type="radio"  name="{.field_id}" {.checked}  value="{.name}">{.name}</label>'].join(""),single_choice_queue_text:['<div class="radio"><label><input type="radio"  name="{.field_id}" {.checked} value="{.name}">{.name}</label></div>'].join(""),single_choice_other_text:['<div class="radio-inline other-choice"><label>','<input type="radio"  name="{.field_id}" value="{.name}" {.checked}   disabled="disabled">其他','<input type="text" disabled="disabled" class="form-control {.extcss}">',"</label></div>"].join(""),multiple_choice_queue_text:['<div class="checkbox"><label><input type="checkbox" value="{.name}" name="{.field_id}" {.checked}>{.name}</label></div>'].join(""),multiple_choice_inline_text:['<label class="checkbox-inline"><input type="checkbox" value="{.name}" name="{.field_id}" {.checked}>{.name}</label>'].join(""),multiple_choice_other_text:['<div class="checkbox-inline other-choice"><label>','<input type="checkbox" value="{.name}" name="{.field_id}"  {.checked}   disabled="disabled">其他','<input type="text" disabled="disabled" class="form-control {.extcss}">',"</label></div>"].join(""),drop_down_text_select:['<select onchange="gf_from_select(this)" class="form-control {.extcss}" rel="id:{.id},parent:{.parent}">{.options}</select>'].join(""),drop_down_text_opt:'<option value="{.name}" {.selected} rel="id:{.id},parent:{.parent}">{.name}</option>',date_text:['<input rows="3" value="{.default_value}"" name="default_value" class="form-control Wdate">'].join(""),mobile_date_text:['<input rows="3" type="date" value="{.default_value}" name="default_value" class="form-control Wdate">'].join(""),code_text:['<div class="captcha"><input type="text" class="form-control {.extcss} w80"/><img src="/Captcha/getcode" alt=""/><a href="#">看不清，换一张</a></div>'].join("")}}(jQuery,window,Gaofen);
"use strict";!function(e,t,i){var n=i.util,a=i.ui,r=(a.Base,function(){var e={};i.on("remove-field",function(t){t.id&&e[t.id]&&d.removeField(t.id)});var d={components:{single_line_text:{title:"单行文本",id:"single_line_text_area"},paragraph_text:{title:"多行文本",id:"paragraph_text_area"},phone_text:{title:"电话",id:"phone_text_area"},phone_mobile_text:{title:"手机",id:"phone_mobile_text_area"},email_text:{title:"Email",id:"email_text_area"},date_text:{title:"日期",id:"date_text_area"},single_choice_text:{title:"单项选择",id:"single_choice_text_area"},drop_down_text:{title:"下拉框",id:"drop_down_text_area"},multiple_choice_text:{title:"复选框",id:"multiple_choice_text_area"}},addFieldChoose:function(e,a,r){return n.parse(i.tpls.get(r),t.extend({field_id:a},e))},addField:function(r,d,l){d||(d=n.createFieldId()),r.extcss=o?"input-lg":"input-sm";var s,c=r.type,u=this,_=c;switch(c){case"single_line_text":case"phone_text":case"phone_mobile_text":case"email_text":case"paragraph_text":"email_text"===c&&(_="single_line_text"),s=i.use(_,t.extend({autoRender:!0,isCreate:r.isCreate||!0,field_id:d,presence:"true"===r.choices.presence||r.choices.presence===!0?!0:!1,number:"true"===r.choices.number||r.choices.number===!0?!0:!1,title_value:r.title_value||"未命名",default_value:r.default_value||"",field_type:c,appendTo:"#fields_area",view:i.tpls.getItemView(_,t.extend({field_id:d,title_value:"未命名",field_type:c},r))},r));break;case"single_choice_text":case"multiple_choice_text":var f=u.choicesItem(c,d,r);s=i.use("single_choice_text",t.extend({autoRender:!0,isCreate:r.isCreate||!0,field_id:d,title_value:r.title_value||"未命名",appendTo:"#fields_area",field_type:c,view:i.tpls.getItemView("choice_text",t.extend({field_id:d,title_value:"未命名",field_type:c,chooses:f.join("")},r))},r));break;case"drop_down_text":r.items||(r.items=[a.drop_down_text.prototype.getItemBase()]);var h=a.drop_down_text.prototype.renderSelect(r.items);s=i.use(c,t.extend({autoRender:!0,isCreate:r.isCreate||!0,field_id:d,presence:"true"===r.choices.presence||r.choices.presence===!0?!0:!1,title_value:r.title_value||"未命名",default_value:r.default_value||"",appendTo:"#fields_area",view:i.tpls.getItemView(c,t.extend({field_id:d,title_value:"未命名",field_type:c,item_content:h},r))},r));break;case"date_text":var p=c;o&&(p="mobile_date_text"),s=i.use(c,t.extend({autoRender:!0,isCreate:r.isCreate||!0,field_id:d,presence:"true"===r.choices.presence||r.choices.presence===!0?!0:!1,title_value:r.title_value||"日期",default_value:r.default_value||"",appendTo:"#fields_area",view:i.tpls.getItemView(p,t.extend({field_id:d,title_value:"未命名",field_type:c},r))},r));break;case"code_text":s=i.use(c,t.extend({autoRender:!0,isCreate:r.isCreate||!0,field_id:d,title_value:r.title_value||"验证码",appendTo:"#fields_area",view:i.tpls.getItemView(c,t.extend({field_id:d,title_value:"验证码",field_type:c},r))},r))}if(l){var m=r.frontIndex;if(void 0!==m){var g=s.jq(),v=g.index();if(m!=v){console.log("change-position");var x=g.parent(),y=x.children().eq(m);g.insertBefore(y)}}}return e[d]=s},choicesItem:function(e,i,n){var r="single",d=this,l=n.items;l=l||a.single_choice_text.prototype.createSample(),"multiple_choice_text"===e&&(r="multiple"),n.items=l;var o=[],l=n.items||a.single_choice_text.prototype.items,s=n.choices.arrange||a.single_choice_text.prototype.arrange;if(l){var c=r+"_choice_"+s+"_text";t.each(l,function(e,t){o.push(d.addFieldChoose(t,i,c))})}return o},afterSort:function(){t("#entry_area").children()},removeField:function(t){return delete e[t]},getFieldById:function(t){return e[t]},getFeildsByType:function(i){var n=[];return t.each(e,function(e,t){t.field_type===i&&n.push(t)}),n},getData:function(){var i={data:{},extData:{}},n=!0;return t.each(e,function(e,t){t.isNullVil()?"code_text"===t.type?i.extData.captcha=t.getData():i.data[t.field_id]=t.getData():n=!1}),n?i:n},rander:function(e){var i="",n="";l?(i=e.fields,n=e.extData,"string"===t.type(i)&&(i=JSON.parse(i)),n&&"string"===t.type(n)&&(n=JSON.parse(n))):(e=e.fields,"string"===t.type(e)&&(e=JSON.parse(e)),i=e.data,n=e.extData,n&&"string"===t.type(n)&&(n=JSON.parse(n))),t.each(i,function(e,t){r.addField(t,t.field_id)}),t.each(n||[],function(e,t){r.addField(t,t.field_id,"esp")}),t("#fields_area").append('<div class="field submit-field"><input type="submit" value="提交" class="btn btn-primary" rel="e:save" id="fbtn"></div>')},randerBase:function(e){var i=t("#entry_area>.form-header");i.find("input").val(e.title),tinymce.get("rich-text-editor").setContent(e.description)}};return d}());i.reg("code_text",n.create(i.ui.fieldComponent,{title:"验证码",field_id:"",presence:!0,nullmsg:"请输入验证码",uri:"/Captcha/getcode",field_type:"code_text",getData:function(){var e=this.jq();return e.find("input").val()},isNullVil:function(){return this.jq().find("input").trigger("blur"),this.isPresenceVil()},onViewReady:function(){var e=this.jq(),t=this;e.find("input").on("blur",function(){var n=t.getIptVal();""===n?t.setError("请输入验证码"):i.Ajax.send("/Captcha/auth?code="+n,{},function(n){"0"==n.errno||(t.setError("请正确输入验证码"),e.find("img").attr("src",t.uri+"?"+ +new Date)),i.fire("codeAuth-once",{isTrue:"0"==n.errno})})}),e.find("img,a").on("click",function(i){i.preventDefault(),e.find("img").attr("src",t.uri+"?"+ +new Date)})}})),i.reg("single_line_text",n.create(i.ui.fieldComponent,{title:"单行文本",isCreate:!0,title_value:"",default_value:"",field_id:"",field_type:"single_line_text",getData:function(){return this.getIptVal()},onViewReady:function(){this.bindVil()}})),i.reg("paragraph_text",n.create(i.ui.fieldComponent,{title:"多行文本",isCreate:!0,title_value:"",default_value:"",field_id:"",field_type:"paragraph_text",getData:function(){var e=this.jq();return t.trim(e.find("textarea").val())},onViewReady:function(){this.bindVil()}})),i.reg("phone_text",n.create(i.ui.fieldComponent,{title:"电话",isCreate:!0,title_value:"",default_value:"",field_id:"",field_type:"phone_text",getData:function(){var e=this.jq();return t.trim(e.find('input[type="text"]').val())},onViewReady:function(){this.bindVil()}})),i.reg("phone_mobile_text",n.create(i.ui.fieldComponent,{title:"手机",isCreate:!0,title_value:"日期",default_value:"",field_id:"",field_type:"phone_mobile_text",getData:function(){var e=this.jq();return t.trim(e.find('input[type="text"]').val())},isNullVil:function(){return this.isPresenceVil()&&this.isPhone()},isPhone:function(){var e=this.getIptVal();return e?/^1[3|4|5|8][0-9]\d{8}$/.test(e)?(this.setError(""),!0):(this.setError("请正确输入手机号"),!1):this.presence?(this.setError("请输入手机号"),!1):!0},onViewReady:function(){var e=this;this.jq().find('input[type="text"]').on("blur",function(){!e.isPhone()})}})),i.reg("date_text",n.create(i.ui.fieldComponent,{title:"日期",isCreate:!0,title_value:"",default_value:"",date_show:"",field_id:"",field_type:"date_text",getData:function(){return this.getIptVal()},onViewReady:function(){if(this.bindVil(),!o){{var e=this.jq().find("input");t.fn.datetimepicker.dates.cn={days:["周日","周一","周二","周三","周四","周五","周六","周日"],daysShort:["日","一","二","三","四","五","六","七"],daysMin:["日","一","二","三","四","五","六","七"],months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],monthsShort:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],today:"今天",meridiem:["am","pm"],clear:"清除"}}e.datetimepicker({weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:2,language:"cn",format:"yyyy-mm-dd",forceParse:0}),t(".datetimepicker-days .prev").text("<"),t(".datetimepicker-days .next").text(">")}}})),a.single_choice_text=i.reg("single_choice_text",n.create(i.ui.fieldComponent,{title:"单项选择",isCreate:!0,title_value:"",field_id:"",items:[{name:"选项",checked:""},{name:"选项",checked:""},{name:"选项",checked:""}],arrange:"inline",field_type:"single_choice_text",getData:function(){var e=this.jq();if("single_choice_text"===this.type)return encodeURIComponent(e.find('input[type="radio"]:checked').val());var i=[];return e.find('input[type="checkbox"]:checked').each(function(e,n){i.push(encodeURIComponent(t(n).val()))}),i},addFieldChoose:function(e,a,r){return n.parse(i.tpls.get(r),t.extend({field_id:a},e))},choicesItem:function(e,i,n){var r="single",d=this;"multiple_choice_text"===i&&(r="multiple");var l=[],o=n.items||a.single_choice_text.prototype.items,s=n.arrange||a.single_choice_text.prototype.arrange;if(o){var c=r+"_choice_"+s+"_text";t.each(o,function(t,i){l.push(d.addFieldChoose(i,e,c))})}return l},createSample:function(){return[{name:"选项",checked:""},{name:"选项",checked:""},{name:"选项",checked:""}]},resetItemDom:function(){var e=r.choicesItem(this.field_type,this.field_id,this.getSideBarData());this.jq().find("#choice_main").html(e.join(""))},onViewReady:function(){this.bindVil()},changePosition:function(e,t,i){i||(i=this.items);var n=i.splice(e,1);i.splice(t,0,n[0]),this.resetItemDom()}})),a.drop_down_text=i.reg("drop_down_text",n.create(i.ui.fieldComponent,{title:"下拉选项",isCreate:!0,title_value:"",field_id:"",field_type:"drop_down_text",item:{id:"0",name:"选项",checked:"",selected:"",parent:"",children:[]},items:[],getData:function(){var e=this.jq(),i=[];return e.find("select").each(function(e,n){i.push(encodeURIComponent(t(n).val()))}),i},getItemBase:function(e,t,i){var a={},e=e||this.item;e.children=[];for(var r in e){var d=e[r];"id"===r&&(d=i||"s_"+n.createFieldId()),a[r]=d,"parent"===r&&(a[r]=t||"")}return a},getItem:function(e,t){if(""===e||"0"===e)return this.items;t||(t=this.items);for(var i=this,n=0,a=t.length;a>n;n++){var r,d=t[n];if(e===d.id)return d;if(d.children&&d.children.length&&(r=i.getItem(e,d.children)),r)return r}return""},reloadSelectView:function(e){var t=this.renderSelect(e||this.items);this.jq().find(".controls").html(t)},renderSelect:function(e,a){if(0===e.length)return"";var r=[],d=[],l="",o="";return e&&e.length||(e=[this.getItemBase()]),t.each(e,function(e,t){t.selected&&(l=t.children&&t.children.length?t.children:[]),""===t.id&&(t.id="s_"+n.createFieldId()),r.push(n.parse(i.tpls.get("drop_down_text_opt"),t)),o=t.parent}),d.push(n.parse(i.tpls.get("drop_down_text_select"),{id:a||"s_"+n.createFieldId(),parent:o,options:r.join("")})),"array"===t.type(l)?d.push(this.renderSelect(l)):e[0].children&&e[0].children.length&&d.push(this.renderSelect(e[0].children)),d.join("")},resetItems:function(e,i){t.each("array"===t.type(e)?e:e.children,function(e,t){t.id===i?(t.checked="checked",t.selected="selected"):(t.checked="",t.selected="")})},deleteItem:function(e,i){var n,a=e;e.children&&(a=e.children),t.each(a,function(e,t){t.id===i.id&&(n=e)}),void 0!==n&&a.splice(n,1)},changeSelect:function(e,t){this.resetItems(t,e.id,!0),this.jq().find(".controls").html(this.renderSelect(this.items))},onViewReady:function(){var e=this;i.on("drop_down_select_onchange",function(t){var i=t.index;if(e.jq().index()===i&&t.obj){var a=t.obj.find("option:selected"),r=n.parseKnV(a.attr("rel")),d=e.getItem(r.id),l=e.getItem(r.parent);e.changeSelect(d,l)}})},changePosition:function(e,t,i){var n=this.getItem(i),a=n.splice(e,1);n.splice(t,0,a[0]),this.renderSelect()}})),e.manageFields=r,i.actions.reg("save",function(){if(!l){var e=r.getData();if(e){var t=i.PD.get("form").id;r.getFeildsByType("code_text").length?i.on("codeAuth-once",function(n){n.isTrue&&i.Ajax.send("/form/form/store?id="+t,{id:t,fields:e},function(e){console.log(e),"0"==e.errno?location.href="/form/form/finish":alert(e.msg)},"post"),i.actions.del("self_codeAuth-once")}):i.Ajax.send("/form/form/store?id="+t,{id:t,fields:e},function(e){console.log(e),"0"==e.errno&&(location.href="/form/success")},"post")}}}),i.on("isShow-adds-area",function(e){var i=t("#add_area");e&&e.show?i.addClass("show-optional-fields"):i.removeClass("show-optional-fields")}),i.on("tips-event",function(e){"success"===e.type});!function(){var e=t("#alert_msg"),i="alert-success",n="alert-danger",a=null,r=3e3,d="success",l={setTips:function(t,i,n){clearTimeout(a),l.setCs(t,i),a=setTimeout(function(){e.display(0),n&&n()},r)},setCs:function(t,a){t===d?e.removeClass(n).addClass(i):e.removeClass(i).addClass(n),e.display(1).find("span").text(a)}};return l}();e.gf_from_select=function(e){var n=t(e),a=n.closest(".field").index();i.fire("drop_down_select_onchange",{obj:t(e),index:a})};var d,l=!0,o=e.location.href.indexOf("mobile")>-1?!0:!1,s=function(e,t){window.parent.postMessage({height:t},e||d)};t(function(){var e=Gaofen.PD.get();e.form.id&&(l=!1),i.event(),r.rander(e.form),window.addEventListener("message",function(e){d="http://"+e.data.host,s(d,t("body").height())},!1)})}(window,jQuery,Gaofen);
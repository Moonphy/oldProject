(function(G, $, win){
    ...
    var validators = {
            ...
            phone : function(elem, v, data, next){
                ...
                else this.report(/^1[3|4|5|8][0-9]\d{8}$/.test(v), data);
                next();
            },
    ...
    ,showFlag : function(isTrue, data){
        ...
        if(cmp.inForm === false){
            ...
            if(isTrue){//暂时不处理
                ...
                this.cmp.eachCallBall(this.$t, data);
            }

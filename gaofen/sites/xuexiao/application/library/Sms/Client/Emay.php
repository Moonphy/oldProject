...
class Emay{
	...
	function __construct($url,$serialNumber,$password,$sessionKey='',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
	{
		...
		$this->soap = new \SoapClient($url, $this->getOptions($options));
	...
	function getOptions($options=array()){
		$this->options['uri'] = $this->namespace;
	...
	function setOutgoingEncoding($outgoingEncoding)
	{
		...
		//$this->soap->soap_defencoding = $this->outgoingEncoding;
		$this->options['encoding'] = $outgoingEncoding;
	...
	function login($sessionKey='')
	{
		...
		$result = $this->soap->__soapCall("registEx", array($params)/*, $this->namespace*/);
	...
	function logout()
	{
		...
		print_r($params); 
		$result = $this->soap->__soapCall("logout", array($params) ,
			$this->namespace
		);
	...
	function getVersion()
	{
		$result = $this->soap->__soapCall("getVersion",
			array(),
			$this->namespace
		);
		return $result;
	...
	function sendSMS($mobiles=array(),$content,$sendTime='',$addSerial='',$charset='UTF-8',$priority=5)
	{
		...
		$params = array('arg0'=>$this->serialNumber,'arg1'=>$this->sessionKey,'arg2'=>$sendTime, 'arg3'=>array(),
			'arg4'=>$content,'arg5'=>$addSerial, 'arg6'=>$charset,'arg7'=>$priority, 'arg8'=>null
			);
		...
		$result = $this->soap->__soapCall("sendSMS",array($params)/*,$this->namespace*/);
		return $result;
	...
	{
		$params = array('arg0'=>$this->serialNumber,'arg1'=>$this->sessionKey);
		$result = $this->soap->__soapCall("getBalance",array($params)/*,$this->namespace*/);
		return $result;
	...
	{
		$params = array('arg0'=>$this->serialNumber,'arg1'=>$this->sessionKey);
		$result = $this->soap->__soapCall("cancelMOForward",array($params)/*,$this->namespace*/);
		return $result;
	}
	...
	function chargeUp($cardId, $cardPass)
	{
		...
		$result = $this->soap->__soapCall("chargeUp",array($params)/*,$this->namespace*/);
		return $result;
	}
	...
	{
		$params = array('arg0'=>$this->serialNumber,'arg1'=>$this->sessionKey);
		$result = $this->soap->__soapCall("getEachFee",array($params)/*,$this->namespace*/);
		return $result;
	}
	...
	function getMO()
	{
		$ret = array();
		$params = array('arg0'=>$this->serialNumber,'arg1'=>$this->sessionKey);
		$result = $this->soap->__soapCall("getMO",array($params)/*,$this->namespace*/);
	...
	{
		$params = array('arg0'=>$this->serialNumber,'arg1'=>$this->sessionKey);
		$result = $this->soap->__soapCall("getReport",array($params)/*,$this->namespace*/);
		return $result;
	}
	...
	function registDetailInfo($eName,$linkMan,$phoneNum,$mobile,$email,$fax,$address,$postcode)
	{
		...
		$result = $this->soap->__soapCall("registDetailInfo",array($params)/*,$this->namespace*/);
		return $result;
   	...
   	function updatePassword($newPassword) 
   	{
		...
		$result = $this->soap->__soapCall("serialPwdUpd",array($params)/*,$this->namespace*/);
		return $result;
   	...
   	function setMOForward($forwardMobile)
   	{
		...
		$result = $this->soap->__soapCall("setMOForward",array($params)/*,$this->namespace*/);
		return $result;
   	}
   	...
   	function setMOForwardEx($forwardMobiles=array())
   	{
		...
		$params = array('arg0'=>$this->serialNumber, 'arg2'=>array(), 'arg1'=>$this->sessionKey);
		...
		foreach($forwardMobiles as $mobile)
		{
			...
			array_push($params['arg2'], $mobile);
		}
		
		$result = $this->soap->__soapCall("setMOForwardEx",array($params)/*,$this->namespace*/);
		return $result;   		

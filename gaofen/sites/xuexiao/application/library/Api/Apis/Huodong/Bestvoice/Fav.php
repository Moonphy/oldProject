...
class Fav extends \Api\Apis\Base
{
    private $_base = null;
    private $_mBase = null;

    public function __construct(\Api\Base\Huodong\Bestvoice\Fav $base, \Api\Base\Huodong\Bestvoice\Material $mBase)
    {
        $this->_base = $base;
        $this->_mBase = $mBase;
    }
    ...
    public function create($p = array())
    {
        ...
        $this->_mBase->incrUnit('fav_num', $p['mid'], true);
        $this->_mBase->incrUnit('fav_num_total', $p['mid'], true);

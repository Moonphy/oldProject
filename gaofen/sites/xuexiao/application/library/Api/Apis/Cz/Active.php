...
use Api\Base\Cz\Active as ActiveBase;
/**
 *  用户动态API
 */
class Active
{
    ...
    {
        $this->_base->setVisited($params, 'gf_cz_watched_entries');
    ...
    {
       $limit = isset($params['limit']) ? $params['limit'] : 5;
       return array_slice($this->_base->getVisited($params, 'gf_cz_watched_entries'), 0, $limit);
    }

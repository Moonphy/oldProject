...
class Pic extends ApiBase\Base {
	...
	static $_LIST_BY_TYPE_CACHE_KEY= 'gzpic:cond:list';
	static $_GET_CACHE_KEY 		= 'gzpic:id';
	static $_TABLE_UNIT_KEY		= 'gzpic:unit:id'; //浏览数缓存

	private $_model = NULL;

	function __construct(\Api_Gz_PicModel $model)
	{
		$this->_model = $model;
	}

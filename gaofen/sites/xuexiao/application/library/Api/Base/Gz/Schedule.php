...
class Schedule extends ApiBase\Base {
	...
	static $_LIST_BY_TYPE_CACHE_KEY= 'gzSchedule:cond:list';
	static $_GET_CACHE_KEY 		= 'gzSchedule:id';
	static $_TABLE_UNIT_KEY		= 'gzSchedule:unit:id'; //浏览数缓存

	private $_model = NULL;

	function __construct(\Api_Gz_ScheduleModel $model)
	{
		$this->_model = $model;
	}

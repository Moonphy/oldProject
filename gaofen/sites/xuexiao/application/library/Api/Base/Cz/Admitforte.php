...
class Admitforte extends ApiBase\Base {
	...
	static $_LIST_BY_TYPE_CACHE_KEY= 'czAdmitforte:cond:list';
	static $_GET_CACHE_KEY 		= 'czAdmitforte:id';
	static $_TABLE_UNIT_KEY		= 'czAdmitforte:unit:id'; //浏览数缓存

	private $_model = NULL;

	function __construct(\Api_Cz_AdmitforteModel $model)
	{
		$this->_model = $model;
	}

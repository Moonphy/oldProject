...
class Admitscore extends ApiBase\Base {
	...
	static $_LIST_BY_TYPE_CACHE_KEY= 'czAdmitscore:cond:list';
	static $_GET_CACHE_KEY 		= 'czAdmitscore:id';
	static $_TABLE_UNIT_KEY		= 'czAdmitscore:unit:id'; //浏览数缓存

	private $_model = NULL;

	function __construct(\Api_Cz_AdmitscoreModel $model)
	{
		$this->_model = $model;
	}
	...
	*/
	public function save($data, $id='', $autoRefresh=true) {
		...
		$fields = array('sid'=>'number', 'year'=>'number', 'score'=>'float', 'memo'=>'string',
		);

...
{
    static $_LIST_BY_TYPE_CACHE_KEY = 'czscore:cond:list';
    static $_GET_CACHE_KEY        = 'czscore:id';
    static $_TABLE_UNIT_KEY        = 'czscore:unit:id'; //浏览数缓存

    private $_model = null;

    public function __construct(\Api_Cz_ScoreModel $model)
    {
        $this->_model = $model;
    }
    ...
    {
        $fields = array('sid' => 'number', 'score_avg' => 'number', 'attend_num' => 'number', 'city_score_avg' => 'number', 't_h_ratio' => 'float',
            'year' => 'number',
        );

...
class UserAgent {
	...
	private function _load_agent_file()
	{
		...
		if (isset($this->platformsCfg))
		{
			$this->platforms = $this->platformsCfg;
			unset($platforms);
			$return = TRUE;
		}

		if (isset($this->browsersCfg))
		{
			$this->browsers = $this->browsersCfg;
			unset($browsers);
			$return = TRUE;
		}

		if (isset($this->mobilesCfg))
		{
			$this->mobiles = $this->mobilesCfg;
			unset($mobiles);
			$return = TRUE;
		}

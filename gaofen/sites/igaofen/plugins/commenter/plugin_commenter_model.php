...
class plugin_commenter_model_class extends AWS_MODEL {
	static $table_name = 'plugin_commenter';
	 ...
	 * @return [type]              [description]
	 */
	public function get_comment_list($type=0, $is_publish=false, $limit=1) {
		$wheres = [];
	...
	public function init_db() {
		return $this->create_answerer_table();
	}

	private function create_answerer_table() {

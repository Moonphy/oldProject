...
class question_class extends AWS_MODEL
{
	...
	public function get_question_info_by_id($question_id, $cache = true)
	{
		...
		$res = $this->format($questions[$question_id]);
	...
	/**
	 * [select_question 查询多条question]
	 * @param  [array]     $field  [description]
	 * @param  [str]     $where  [description]
	 * @param  [str]     $order  [description]
	 ...
	 * @date   2017-01-03
	 */
	public function select_question($field=null, $where=null, $order=null, $limit=null, $offset=null){
		$res=$this->fetch_field_all('question', $field, $where, $order, $limit, $offset);
	...
	public function format($row) {		
		$row['question_cover_url_big']		= $this->get_cover_full_path($row['question_cover_url'], 'big');
		$row['question_cover_url_small']	= $this->get_cover_full_path($row['question_cover_url'], 'small');
		$row['question_cover_url']			= $this->get_cover_full_path($row['question_cover_url']);
		return $row;
	}
	...
	public function update_question_id($data,$id){
		if($id){
			$affect_num=$this->update('question',$data,"question_id = $id");
			return $affect_num;
		}
	}
}

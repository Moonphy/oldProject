...
function ajaxRst($rst, $errno = 0, $err = '', $return = false, $callback = false)
{
...
/**
 * [file_upload_iconv 上传文件与其他文字表单时出现乱码时使用]
 * @param  [array]     $data [储存数据库前的数据]
 * @return [type]           [description]
 * @author ken
 * @date   2016-12-27
 */
function file_upload_iconv($data){

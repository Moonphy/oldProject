...
class AWS_MODEL
{
	...
	/**
	 * [fetch_field_all 可选字段查询全部数据]
	 * @param  [type]     $table  [数据表]
	 * @param  [array]     $field  [可选字段]
	 * @param  [type]     $where  [查询条件]
	 * @param  [type]     $order  [排序]
	 * @param  [type]     $limit  [限制查询结果]
	 * @param  integer    $offset [偏移量]
	 * @return [type]             [查询结果]
	 * @author ken
	 * @date   2016-08-22
	 */
	public function fetch_field_all($table, $field= null, $where = null, $order = null, $limit = null, $offset = 0)
	{
		$this->slave();
		...
		if(!$field){
			...
			$select->from($this->get_table($table), $field);
		}
	...
	public function query_all_other($sql, $limit = null, $offset = null, $where = null, $order_by = null, $group_by = null)
	{
		$this->slave();
	 ...
	 * @date   2016-08-22
	 */
	public function fetch_field_row($table, $field='', $where = null, $order = null)
	{
		$this->slave();

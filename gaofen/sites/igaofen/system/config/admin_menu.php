...
$config[] = array(
    ...
    'children' => array(
        ...
        array(
            'id' => 313,
            'title' => AWS_APP::lang()->_t('年龄段管理'),
            'url' => 'admin/age/list/'
        ),
        array(
            'id' => 315,
            'title' => AWS_APP::lang()->_t('首页活动管理'),
            'url' => 'admin/activity/list/'
        ),
        array(
            'id' => 316,
            'title' => AWS_APP::lang()->_t('首页轮播管理'),
            'url' => 'admin/loop/list/'
        ),
        array(
            'id' => 317,
            'title' => AWS_APP::lang()->_t('首页超级话题设置'),
            'url' => 'admin/s_topic/list/'
        ),
    )
);

...
$config['action_details'][notify_class::TYPE_SPECIALIST_ANSWER] = array(
	'user_setting' => 0,
	'combine' => 0,
	'desc' => AWS_APP::lang()->_t('我的提问已回复')
);

$config['action_details'][notify_class::TYPE_SPECIALIST_QUESTION] = array(
	'user_setting' => 0,
	'combine' => 0,
	'desc' => AWS_APP::lang()->_t('收到了用户提问')
);

$config['action_details'][notify_class::TYPE_SPECIALIST_TAP] = array(
	'user_setting' => 0,
	'combine' => 0,
	'desc' => AWS_APP::lang()->_t('你的回复被偷听')
);